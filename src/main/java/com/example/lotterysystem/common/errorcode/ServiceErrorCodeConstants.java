...
public interface ServiceErrorCodeConstants {
     ...
     *人员模块错误码
     */
    ErrorCode REGISTER_PARAM_IS_EMPTY = new ErrorCode(100,"注册信息为空");
    ...
    ErrorCode ADMIN_PASSWORD_IS_EMPTY = new ErrorCode(104, "管理员密码不能为空");
    ...
    ErrorCode FIND_ACTIVITY_LIST_PARAM_ERROR = new ErrorCode(308, "查询活动列表参数为空");
    ErrorCode FIND_ACTIVITY_LIST_ID_ERROR = new ErrorCode(309, "查询活动id为空");
    /**
     *图片错误码
     */
